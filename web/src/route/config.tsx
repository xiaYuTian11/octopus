...
const KeyPool_Module = lazyWithPreload(() => import('@/components/modules/keypool').then(m => ({ default: m.KeyPool })));
...
export const ROUTES: RouteConfig[] = [
    ...
    { id: 'keypool', label: 'KeyPool', icon: Key, component: KeyPool_Module },
